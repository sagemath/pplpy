...
from .constraint cimport Constraint, Constraint_System 
...
####################################################
#TODO move _make_Constraint_from_richcmp, _wrap_Constraint and _wrap_Constraint_System in constraint.pyx
